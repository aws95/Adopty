...
<head>
    ...
    <title>Adopty</title>
    <link href="../../front_Office/assets/img/ADOPTY-LOGO.png" rel="icon">
                                    ...
                                    <form>
                                        ...
                                        <div
                                            ...
                                            <a class="small" href="password.html">Forgot Password?</a><a
                                                class="btn btn-primary" href="index.html">Login</a></div>
                                    </form>
                                </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Adopty 2020</div>
                    </div>
                </div>
            </footer>
        </div>
